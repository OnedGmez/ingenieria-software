...
const routes = [
  ...
  {
    path: '/inventario/:id/:rol/:sucursalcode',
    name: 'inventario',
  ...
  {
    path: '/proveedores/:id/:rol/:sucursalcode',
    name: 'proveedores',
    // route level code-splitting
    // this generates a separate chunk (about.[hash].js) for this route
    // which is lazy-loaded when the route is visited.
    component: function () {
      return import(/* webpackChunkName: "about" */ '../views/proveedoresView.vue')
    }
  },,
  {
    path: '/rproveedores/:id/:rol/:sucursalcode',
    name: 'rproveedores',
    // route level code-splitting
    // this generates a separate chunk (about.[hash].js) for this route
    // which is lazy-loaded when the route is visited.
    component: function () {
      return import(/* webpackChunkName: "representantes" */ '../views/representantesView.vue')
    }
  },
  {
    path: '/ordenes/:id/:rol/:sucursalcode',
    name: 'ordenes',
    // route level code-splitting
    // this generates a separate chunk (about.[hash].js) for this route
    // which is lazy-loaded when the route is visited.
    component: function () {
      return import(/* webpackChunkName: "about" */ '../views/ordenesView.vue')
    }
  }
]
